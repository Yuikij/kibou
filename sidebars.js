...
const sidebars = {
    ...
    // 备忘录
    SuperGame: [{type: 'autogenerated', dirName: 'memorandum/SuperGame'}],

    deepResearch: [{type: 'autogenerated', dirName: 'memorandum/深度解读'}],
    // 提示词
    prompt: [{type: 'autogenerated', dirName: 'memorandum/提示词'}],

    // 提示词
    chat: [{type: 'autogenerated', dirName: 'memorandum/chatgpt'}],
    // 算法
...
// ---------- 基础知识 -----------
    ...
    // 软件框架
    framework: [{type: 'autogenerated', dirName: 'basicKnowledge/framework'}],
    // 网络
...
// ---------- 基础软件 -----------
    ...
    linux: [{type: 'autogenerated', dirName: 'basicSoftware/Linux'}],
    middleware: [{type: 'autogenerated', dirName: 'basicSoftware/中间件'}],
    // 语言学习
